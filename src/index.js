...
(async () => {
  try {
    ...
    const recordFilePath = "private/2025Apr/Order_Apr18.json";
    const vendorFilePath = "private/VendorID_Apr_18.json"
    const ptDefineCsvFile = "private/PaymentTerm_define.csv";
    const paidCsvFile = "private/2025Apr/paid_Apr18.csv";
    const finalFilePath = await processFullSourcing(recordFilePath, vendorFilePath, ptDefineCsvFile, paidCsvFile);
