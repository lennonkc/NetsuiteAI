...
(async () => {
  try {
    ...
    const recordFilePath = "private/2025May/PurchaseOrderMay14.json"; // PO data (can be generated by SourcePO.js) From SaveSearch "SCO - Purchase Order Information " 
    const vendorFilePath = "private/VendorID_May_14.json"; // Vendor data (can be generated by vendorID.js) From Netsuite
    const ptDefineCsvFile = "private/PaymentTerm_define.csv"; // Payment term definitions
    const paidCsvFile = "private/paid_PO_Example.csv"; // Paid records, From Nick`s Paid data
